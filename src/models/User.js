...
const userSchema = new mongoose.Schema({
  ...
  // Persisted appearance preferences (theme, accent colour, background palette).
  // Stored as a plain object so we never need a migration when fields are added.
  // Null / empty object means "use defaults" — the frontend handles that gracefully.
